...
const FormAdvanced = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>
          Form Advanced | Lexa - Responsive Bootstrap 5 Admin Dashboard
        </title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                badges to display the maximum lenght of the field where the user
                is inserting text.{" "}
              </p>
              ...
              <div className="mt-3">
                ...
                <p className="text-muted m-b-15">
                  Please note: if the <code>alwaysShow</code> option is enabled,
                  the <code>threshold</code> option is ignored.
                </p>
                <Input
                  type="text"
                  maxLength="25"
                ...
                {disbadge ? (
                  <span className="badgecount">
                    ...
                    out of <span className="badge badge-success">25</span> chars
                    available
                  </span>
                ) : null}
              </div>
